...
<div class="page" style="height: 100%">
    <form action="<?php echo url('eleve', 'saisie'); ?>" method="post">
        ...
        <div id="onglet1" class="onglet" style="display: block;"></div>
        <div id="onglet2" class="onglet" style="display: none;"></div>
        <div id="onglet3" class="onglet" style="display: none;"></div>
        <div id="onglet4" class="onglet" style="display: none;"></div>
