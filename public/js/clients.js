...
var ajoutForm = function (id) {
    ...
    switch (elem){
        case 1: _url = "./ajax/eleve"; content = $("#eleve_content"); img_pp = $("#dialog-1");break;
        case 2: _url = "./ajax/profprincipale"; content = $("#prof_content"); img_pp = $("#ajout_pp"); break;
        case 3: _url = "./ajax/cpeprincipale"; content = $("#cpe_content"); img_pp = $("#ajout_cpe");break;
        case 4: _url = "./ajax/adminprincipale"; content = $("#admin_content"); img_pp = $("#ajout_ra");break;
        case 5: _url = "./ajax/ajoutmatiere"; content = $("#matiere_content"); img_pp = $("#listematiere"); 
            var matiere = $("input[name=matiere]");
            tmp = $(id + " span select");
            var mat = {'matiere' : tmp[0].value,
                'enseignant' : tmp[1].value, 
                'groupe' : tmp[2].value, 
                'coeff' : $(id + " span input").val()};
